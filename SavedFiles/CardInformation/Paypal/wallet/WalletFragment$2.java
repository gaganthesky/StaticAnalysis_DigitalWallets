...
import com.paypal.android.foundation.account.model.BankAccount.Id;
import com.paypal.android.foundation.core.model.UniqueId;
import com.paypal.android.p2pmobile.PayPalApp;

class WalletFragment$2
  implements AdapterView.OnItemClickListener
{
  final WalletFragment this$0;

  WalletFragment$2(WalletFragment paramWalletFragment)
  {
  }

  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    Object localObject3 = TrackPage.Point.BankDetails;
    ...
    if (localObject1 != null)
    {
      ...
      localObject2 = (BankAccount.Id)localObject2;
 ...
 * Qualified Name:     com.paypal.android.p2pmobile.fragment.wallet.WalletFragment.2
